...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='community.CommunityLeadershipType', verbose_name='Descrição'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='community',
            name='products',
            field=models.ManyToManyField(related_name='communities', to='product.Product', verbose_name='Produtos'),
        ),
    ]
