...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='products_location', to='product.ProductCollectionPoint', verbose_name='Local de coleta/colheita'),
        ),
    ]
